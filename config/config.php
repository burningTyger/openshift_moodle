...
$CFG->dbhost    = $_ENV['OPENSHIFT_MYSQL_DB_HOST'];  // eg 'localhost' or 'db.isp.com' or IP
$CFG->dbname    = $_ENV['OPENSHIFT_APP_NAME'];     // database name, eg moodle
$CFG->dbuser    = $_ENV['OPENSHIFT_MYSQL_DB_USERNAME'];   // your database username
$CFG->dbpass    = $_ENV['OPENSHIFT_MYSQL_DB_PASSWORD'];   // your database password
...
$CFG->dboptions = array(
    ...
    'dbport'    => $_ENV['OPENSHIFT_MYSQL_DB_PORT'],          // the TCP port number to use when connecting
...
$CFG->passwordsaltmain = $_ENV['OPENSHIFT_SECURE_TOKEN'];
